            ...
            if len(movie) != 1:
                ...
                for du in d:
                    if du not in str(movie):
                        toPrint.append(du)
                if len(toPrint) > 1:
                    print(str(len(toPrint)) + " Episodes are missing " + "in " + season.replace("S",
                                                                                                "Season *") + "* :    ",
                          str(toPrint).replace("[", "").replace("]", "").replace("\'", ""))
                elif len(toPrint) == 1:
                    print("1 Episode is missing " + "in " + season.replace("S", "Season *") + "* :    ",
                          str(toPrint).replace("[", "").replace("]", "").replace("\'", ""))
                else:
